extension PredicateNet {
  ...
  public func markingGraph(from marking: MarkingType) -> PredicateMarkingNode<T>? {
    ...
    //     var successorMap: PredicateBindingMap<T> = [:]
    ...
    //           if PredicateNet.greater(successor, other.marking) {
    //             return nil
    //           }
    //           if PredicateNet.equals(successor, other.marking) {
    //             successorMap[binding] = other
    //           }
    //         }
    //         guard successorMap[binding] == nil else { continue }
