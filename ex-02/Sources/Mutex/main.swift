...
// TESTTTTTTT
	// print(initialMarking(Place("p2"))) : va afficher le marquage
print("--------")
print(initialMarking(Place("p1")))
// print(initialMarking((model.places[at: 1]))
print("--------")

print("££££££££££")
print(Marking(Place("p1")))
// print(initialMarking((model.places[at: 1]))
print("£££££££££")

let c  = model.incidenceMatrix
let s  = model.characteristicVector(of: [Transition("t0"), Transition("t1"), Transition("t0")]) // vecteur caractéristique, contient combien de fois les transitions sont tirers (à leur position)
