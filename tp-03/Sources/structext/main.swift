...
//In computer programming, an enumerated type is a data type consisting of a set of named values called enumerators of the type.
//Placeset est un enum il peut etre opa opb ou res
